...
from ultralytics.nn.backbone.MobileNetV2 import *
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 SeBlock, G_bneck, conv_bn_relu_maxpool, Shuffle_Block, GhostConvV2, C2f_GhostV2, C3GhostV2, stem,
                 MBConvBlock):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3, C2f_Faster, C2f_ODConv, C2f_Faster_EMA, C2f_DBB,
                     ...
                     C3_FADC, C2f_FADC, C3_PPA, C2f_PPA, RGCSPELAN, C2f_GhostV2, C3GhostV2):
            ...
            m = m(*args)
            c2 = m.channel
        elif m in {conv_bn_hswish, MobileNetV3_InvertedResidual, ConvBNReLU, InvertedResidual}:
            c1, c2 = ch[f], args[0]
