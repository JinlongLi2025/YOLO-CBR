...
__all__ = ['DyHeadBlock', 'DyHeadBlockWithDCNV3', 'Fusion', 'C2f_Faster', 'C3_Faster', 'C3_ODConv', 'C2f_ODConv', 'Partial_conv3', 'C2f_Faster_EMA', 'C3_Faster_EMA', 'C2f_DBB',
           ...
           'C3_PPA', 'C2f_PPA', 'CSMHSA', 'SRFD', 'DRFD', 'CFC_CRB', 'SFC_G2', 'CGAFusion', 'CAFM', 'CAFMFusion', 'RGCSPELAN', 'SeBlock', 'G_bneck', 'conv_bn_relu_maxpool', 'Shuffle_Block',
           'GhostConvV2', 'C2f_GhostV2', 'C3GhostV2', 'stem', 'MBConvBlock']
...
class MBConvBlock(nn.Module):
    def __init__(self, inp, final_oup, k, s, expand_ratio, drop_connect_rate, has_se=False):
        ...
        self.drop_connect = nn.Dropout2d(drop_connect_rate)
